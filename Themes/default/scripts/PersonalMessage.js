...
smf_PersonalMessageSend.prototype.init = function()
{
	if (!this.opt.bBccShowByDefault)
	{
		...
		oBccLink.onclick = showBcc.bind(this);
	}
...
smf_PersonalMessageSend.prototype.callbackAddItem = function(oEvent)
{
	this.oToAutoSuggest.deleteAddedItem(oEvent);
	this.oBccAutoSuggest.deleteAddedItem(oEvent);
